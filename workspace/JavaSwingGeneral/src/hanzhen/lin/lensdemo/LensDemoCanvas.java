...
public class LensDemoCanvas extends JPanel {
        ...
        addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                ...
                if (parentDemo != null) {
                    ...
                    if (parentDemo.getSolveFor() == LensDemoApplication.SolveFor.V) {
                        parentDemo.setValueExternal(f, tmp, v, heightTmp,
                                                    LensDemoApplication.SolveFor.V);
                    } else if (parentDemo.getSolveFor() == LensDemoApplication.SolveFor.U) {
                        parentDemo.setValueExternal(f, v, -tmp, heightTmp,
                                                    LensDemoApplication.SolveFor.U);
                    }
                }
    ...
    public void setObjectHeight(double objectHeight) {
        ...
        if (parentDemo.getSolveFor() == LensDemoApplication.SolveFor.U) {
            objHeight = -u / v * objectHeight;
        }//If solving for U, the height is taken as height of image.
        else {
