...
public class LensDemoApplication {
	...
	public static void main(String[] args) {
		...
		//Mostly autogenerated by eclipse.
	...
	private void initialize() {
		...
		//It uses a layout called gridbag layout. It sets the height/width/expand weight of each colum/row.
		...
		//Construct spiner and sliders for f, the focal length.
		...
		sliderF.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if(!solveFor.equals(SolveFor.F)){
                	...
                	//has occured. Call the function to deal with the change.
                }
            }
		...
		spinnerF.getModel().addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e){
				...
				//Change the actual decimal value of f to the interger that can be stored in sliders.
		...
		//Construct spiner and sliders for u, the distance of the object.
		//Since the process is alimost identical to the previous process for f, redundant commenting is saved.
		...
		//Construct spiner and sliders for v,the distance of the image.
		//Since the process is alimost identical to the previous process for f, redundant commenting is saved.
	...
	private void changeUnknown(String str,int stateChange){
		...
		//If a variable is deselected as an unknown, ensable its spinner and sliders.	
		}
	}
	private void valueChanged(){
		...
		//Solve for the equation according to the value of f, u and v and which unknwon 
		//varaible to be solved for. Update the unknown variable according to the result.
		identifyType(f,u,v);
	...
	public void setValueExternal(double f,double u,double v,double size,SolveFor sf){
		...
		//If the size is not stated, use the deafault value.
